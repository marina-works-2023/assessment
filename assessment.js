...
//ボタン押下で診断実行
assessmentButton.onclick = function () { //アロー関数assessmentButton.onclick = () => {
  ...
  //診断結果表示エリアの作成
  resultDivided.innerText = ''; //結果表示をクリア
  ...
  resultDivided.appendChild(paragraf);

  //ツイートエリア
  tweetDivided.innerText = '';//ツイートエリアのクリア
